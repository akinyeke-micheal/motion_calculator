...
int main(void)
{
	...
	int u1, t1, a1,  distance1, velocity1;  /* Variables for linear motion */
	...
	if (choice == 1)
	{
		...
		do
		{
			...
			if (linchoice == 1)
			{
				...
				printf("\nPlease, enter the value of the initial velocity(u) of the body/particle in motion!!!\n");
				scanf("%d", &u1);
				printf("\nPlease,  enter the value of the time taken(t) in the course of motion!!!\n");
				scanf("%d", &t1);
				printf("\nPlease, enter the value of the acceleration(a) of the body or particle in the course!!!\n");
				scanf("%d", &a1);
				...
				scanf("%d", &u2);
				printf("\n Please, enter the value of the acceleration of the body!!!\n\n");
				scanf("%d", &a2);
				printf("Please enter the value of the total time(t) taken for motion!!!\n\n ");
				scanf("%d", &t2);
				velocity1 = velocity(u2, t2, a2);
				printf("The velocity of the body in motion is %dm/s\n\n", velocity1);
			} else if (linchoice == 3) {
				printf(" THE ACCELERATION OF A BODY IN MOTION\n\n");
				printf("\n Please enter the value of velocity/final velocity(v) taken by the body in motion!!!1\n\n");
				scanf("%d", &v3);
				printf("\n please enter the value of the initial velocity (u) of the body in motion!!!\n\n");
				scanf("%d", &u3);
				printf("\n Please enter the value of the total time taken(t) for the body in the course of motion!!!\n\n");
				scanf("%d", &t3);
			...
			} else if (linchoice == 4)
			{
				...
				printf("\n Please enter the value of velocity/final velocity(v)!!!\n\n");
				scanf("%d", &v4);
				printf("\n please enter the value of the initial velocity (u) of the body in motion!!!\n\n");
				scanf("%d", &u4);
				printf("\n Please enter the value of the acceleration of the body!!!\n\n");
	...
	} else if (choice == 2)
	{
		...
		} else if (prochoice == 3)
		{
			...
			printf("The total time of flight taken is %dseconds\n", total_time);
		} else if (prochoice == 4)
		{
			...
			printf("The total time taken to reach maximum height is %d\n", time_hmax);
		} else if (prochoice == 5)
		{
			...
			printf("The height attained by the body/particle in motion is %dmetres\n", maxheight);
		}
	}
